...
results = collector.collect_drug_reviews(
    drug_name="Lipitor",
    max_results=20,
    lambda_function_arn="arn:aws:lambda:us-east-1:123456789012:function:pr-sentiment-tavily-search-processor"
)
...
response = bedrock_agent_runtime.invoke_inline_agent(
    ...
    actionGroups=[{
        ...
        'actionGroupExecutor': {
            'lambda': 'arn:aws:lambda:us-east-1:123456789012:function:pr-sentiment-tavily-search-processor'
        }
    }],
